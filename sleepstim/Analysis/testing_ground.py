...
for i, files in enumerate(files_list):
    ...
    # save data
    save_preprocess_sleep_data(Data, path='/media/administrator/data/Study_1_data/Pre-processed_data/Experimental_classifier_validation/' + files.split('/')[-2] + '_preproc_data_cv.p')


#%%
## Create pink noise ERPs
...
epochs.filter(l_freq = None, h_freq = 2.0)
